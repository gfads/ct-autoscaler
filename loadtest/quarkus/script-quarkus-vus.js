...
export const options = {
    ...
    scenarios: {
        ...
        experiment: {
            ...
            gracefulRampDown: '0s',
            stages: [
                { target: 2*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 2*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 2*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 3*baseVUs +randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 3*baseVUs +randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 3*baseVUs +randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 1*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 1*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 1*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 2*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
                { target: 2*baseVUs+randomIntBetween(baseVUs*-0.1, baseVUs*0.1), duration: '1m' },
