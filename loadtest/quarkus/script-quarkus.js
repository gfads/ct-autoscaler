...
export const options = {
    ...
    scenarios: {
        ...
        experiment: {
            ...
            stages: [
                { target: 3*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 3*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 3*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 0.2*requestRate +randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 0.2*requestRate +randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 0.2*requestRate +randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 1*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 1*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 1*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 2*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 2*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
                { target: 2*requestRate+randomIntBetween(requestRate*-0.2, requestRate*0.2), duration: '1m' },
            ]
        },
