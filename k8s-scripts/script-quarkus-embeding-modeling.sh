...
kind create cluster --config ./kind/cluster-node-port-data-mapping.yaml
...
sleep 3
kubectl apply -f ./embedded-quarkus/jvm-tests/baseline
#kubectl apply -f ./quarkus/jvm-tests
